class SimpleLabel {
    ...
    __repositionLabel(target) {
        ...
        const labelTop = y < 0.5 ? targetTop + targetHeight : targetTop - targetHeight - labelContainerHeight;
        const labelLeft = x < 0.5 ? targetLeft + targetWidth : targetLeft - targetWidth - labelContainerWidth;
    ...
    __createLabel() {
        ...
        this.labelContainer.style.padding = "1.3em .7em";
