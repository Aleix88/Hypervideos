...
var BottomBarController = /*#__PURE__*/function () {
  ...
  _createClass(BottomBarController, [{
    ...
    key: "__changeButtonIcon",
    value: function __changeButtonIcon(buttonClass, iconName) {
    ...
    key: "__createControlButton",
    value: function __createControlButton(buttonClass, buttonIcon, eventHandler) {
      var buttonContainer = this.htmlManager.createElement("div", {
...
var HyperimageController = /*#__PURE__*/function () {
  function HyperimageController(imageSRC, containerID, config) {
    ...
    value: function __fullScreenStateChanged(isFullScreen) {
      if (this.imageContainer != null) {
        if (isFullScreen === true) {
          var imageWidthMargin = window.innerWidth - this.config.size.width;
          var imageHeightMargin = window.innerHeight - this.config.size.height;
          var shouldWidthShrink = imageHeightMargin >= imageWidthMargin;
...
var Hypervideo = /*#__PURE__*/function () {
  ...
  _createClass(Hypervideo, [{
    ...
    key: "setupHypervideo",
    value: function setupHypervideo(configJSON) {
      ...
      if (this.videoType === Hypervideo.IMAGE_TYPE) {
        var hyperImageController = new HyperimageController(this.videoURL, this.containerID, this.config);
        ...
        var hypervideoController = new HypervideoController(this.videoURL, this.videoType, this.containerID, videoManager, this.config);
        hypervideoController.createSkeleton();
      }
    }
  }, {
    key: "__configJSONToObject",
    value: function __configJSONToObject(configJSON) {
      var _this10 = this;
...
var HypervideoController = /*#__PURE__*/function () {
  ...
  _createClass(HypervideoController, [{
    ...
    key: "__maintainAspectRation",
    value: function __maintainAspectRation(hypervideo) {
    ...
    value: function __filterTagsByDuration() {
      ...
      this.config.tags = this.config.tags.filter(function (e) {
        return e.timeConfig.timestamp <= _this11.videoManager.getVideoDuration();
      });
    }
  }, {
    key: "__addVideoTag",
